...
- `experiment-design.md` in the loop directory, from
  ...
  external research / hypothesis / search space / evaluation method /
  constraints / acceptance criteria / out of scope.
...
4. Write the design doc. For every section, present the user a question with
